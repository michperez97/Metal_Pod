...
{
    public class ToxicScreenFeature : ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        private class ToxicScreenPass : ScriptableRenderPass
        {
            private readonly string _profilerTag;
            private Material _material;
            private RTHandle _temporaryColorTexture;

            public ToxicScreenPass(string profilerTag, RenderPassEvent passEvent)
            {
        ...
        private ToxicScreenPass _pass;

        public override void Create()
        {
            _pass = new ToxicScreenPass("MetalPod Toxic Screen", settings.renderPassEvent);
        }
