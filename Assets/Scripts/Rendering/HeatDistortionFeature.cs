...
namespace MetalPod.Rendering
{
    public class HeatDistortionFeature : ScriptableRendererFeature
    {
        ...
        private class HeatDistortionPass : ScriptableRenderPass
        {
            private readonly string _profilerTag;
            private Material _material;
            private RTHandle _temporaryColorTexture;

            public HeatDistortionPass(string profilerTag, RenderPassEvent passEvent)
            {
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                RenderingUtils.ReAllocateIfNeeded(
                    ...
                    name: "_MetalPodHeatDistortionTemp");
            }
        ...
        private HeatDistortionPass _pass;

        public override void Create()
        {
            _pass = new HeatDistortionPass("MetalPod Heat Distortion", settings.renderPassEvent);
        }
