...
{
    public class DamageOverlayFeature : ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        private class DamageOverlayPass : ScriptableRenderPass
        {
            private readonly string _profilerTag;
            private Material _material;
            private RTHandle _temporaryColorTexture;

            public DamageOverlayPass(string profilerTag, RenderPassEvent passEvent)
            {
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                RenderingUtils.ReAllocateIfNeeded(
                    ...
                    name: "_MetalPodDamageOverlayTemp");
            }
        ...
        private DamageOverlayPass _pass;

        public override void Create()
        {
            _pass = new DamageOverlayPass("MetalPod Damage Overlay", settings.renderPassEvent);
        }
